...
public class Compar {
    ...
    public Compar(AndroidDriver driver) {
        this.driver = driver;
    }
    ...
    public void selecaoProduto(){
        ...
        produto.click();
        MobileElement btnComprar= (MobileElement) driver.findElementById("br.com.alura.aluraesporte:id/detalhes_produto_botao_comprar");
        btnComprar.click();
    }
}
